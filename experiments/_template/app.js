...
const state = {
  ...
  tasksByStep: [
    [
      { id:"t1", type:"text", prompt:"Was brauchst du für den Aufbau?", placeholder:"Material: …" }
    ],
    [
      { id:"t2", type:"mcq", prompt:"Worauf achtest du beim Ziehen von Objekten?", options:["Auf die Richtung", "Nur auf Farben"], correct:[0],
        feedback:{ ok:"Genau: Richtung/Position zählt.", wrong:"Tipp: Beobachte die Veränderung beim Verschieben." } }
    ],
    [
      { id:"t3", type:"text", prompt:"Beschreibe deine Beobachtung.", placeholder:"Ich beobachte, dass …" }
    ],
    [
      { id:"t4", type:"textcheck", prompt:"Formuliere einen Merksatz.", placeholder:"Merksatz: …", minChars: 15 }
    ]
  ]
};
...
function seedObjects(){
  // Platzhalterobjekte (kopieren & anpassen)
  state.objects = [
    {id:"obj1", type:"block", x:260, y:320, rot:0, w:240, h:70, draggable:true},
    {id:"obj2", type:"chip",  x:650, y:340, rot:0, w:60,  h:26, draggable:true},
    {id:"obj3", type:"chip",  x:720, y:410, rot:0, w:60,  h:26, draggable:true},
  ];
}
